...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["বেশি bot Bot করলে leave নিবো কিন্তু😒😒 " , "JASSE ADMIN KE BINA KOI OR AISE BULAAYEGA TO UXKI MAA CHOD DUGA 🫨👍" , "  
    ...
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "😽")) {
     return api.sendMessage("AIXE KISS TO MERA JASS ADMIN DETA HAI APKE HATERX KI MAA KO 🥺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "sim") || (event.body.toLowerCase() == "simsimi")) {
     return api.sendMessage("ADMIN KO BULAAU KYA ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🫦") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("JASS ADMIN APNE HATERX KI BHAIN KO AISE HI LIPX KRKE CHUSTA HAI।", threadID);
   };
